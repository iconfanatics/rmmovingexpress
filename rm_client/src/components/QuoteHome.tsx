              ...
              <div className={styles.checkboxItem}>
                {interestsOptions.map((item) => (
                  <label key={item.value} className={classes.checkboxWrapper}>
                    <input
                      type="checkbox"
                      checked={form.interested.includes(item.value)}
                      onChange={() =>
                        handleCheckboxChange("interested", item.value)
                      }
                    />
                    {item.label}
                  </label>
                ...
                <div className={styles.involvedChekbox}>
                  {involvedOptions.map((item) => (
                    <label key={item.value} className={classes.checkboxWrapper}>
                      <input
                        type="checkbox"
                        checked={form.involved.includes(item.value)}
                        onChange={() =>
                          handleCheckboxChange("involved", item.value)
                        }
                      />
                      {item.label}
                    </label>
