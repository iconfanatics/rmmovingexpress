            ...
            <v-btn
              ...
              @click="
                newMessageCounter && newMessageCounter > 0
                  ? $router.push(localePath('/support/live'))
                  : ''
              "
    ...
    accountsMenuItems() {
      return [
        ...
        },
        {
          icon: 'account_circle',
          text: 'Service Banner',
          link: this.localePath('/service/service-banner')
        },
        {
          icon: 'mdi-alpha-t-box',
          text: 'Service Content',
          link: this.localePath('/service/service-page')
        },
        {
          icon: 'mdi-alpha-t-box',
          text: 'Service Section Two',
          link: this.localePath('/service/service-section-two')
        },
        {
          icon: 'mdi-alpha-t-box',
          text: 'Faqs',
          link: this.localePath('/service/service-faq')
        }
      ]
    }
  },
