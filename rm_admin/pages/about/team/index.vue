  ...
  <client-only>
    <div>
      ...
      <v-row>
        <v-col cols="12" md="12">
          ...
          >
            <!--start table header-->
            <v-layout>
              <v-flex xs8 sm8 md8 class="zd-tbl-title">Team</v-flex>
            </v-layout>
      ...
      >
        ...
        <!-- End of Close Button -->
        <div class="de-drawer-header">Add New Team</div>
        <v-divider></v-divider>
                    ...
                    <v-flex xs12 sm12 md12>
                      ...
                      >
                        <v-text-field
                          label="Designation"
                          required
                          v-model="newServicePage.designation"
      ...
      >
        ...
        <!-- End of Close Button -->
        <div class="de-drawer-header">Edit Team</div>
        <v-divider></v-divider>
        <div class="de-box de-drawer-content-box">
          <ValidationObserver
                    ...
                    <v-flex xs12 sm12 md12>
                      ...
                      >
                        <v-text-field
                          label="Designation"
                          required
                          v-model="editServicePage.designation"
                          :error-messages="errors"
                          outlined
                        ></v-text-field>
                      </ValidationProvider>
...
export default {
  ...
  computed: {
    ...
    isValidToServicePage() {
      if (
        this.newServicePage.designation &&
        this.newServicePage.name &&
        this.newServicePage.details &&
    ...
    isValidToUpdateServicePage() {
      if (
        this.editServicePage.designation &&
        this.editServicePage.name &&
        this.editServicePage.details
      ) {
        return true
      } else {
        return false
  ...
  methods: {
    ...
    async addNewServicePage() {
      try {
        ...
        formData.append(
          'newServicePage.designation',
          _this.newServicePage.designation
        )
        formData.append('newServicePage.name', _this.newServicePage.name)
        formData.append('newServicePage.details', _this.newServicePage.details)

        await _this.$axios
          .$post(`${addNewTeamUrl}`, formData)
          .then((response) => {
    ...
    async updateServicePage() {
      try {
        ...
        formData.append(
          'editServicePage.designation',
          _this.editServicePage.designation
        )
        formData.append('editServicePage.name', _this.editServicePage.name)
        formData.append(
        ...
        _this.$swal
          .fire({
            ...
            preConfirm: (isConfirm) => {
              return _this.$axios
                .$post(changeTeamStatusUrl, {
                  teamId: servicePageId
                })
                .then((response) => {
                  return response
                })
