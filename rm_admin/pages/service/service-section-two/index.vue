    ...
    <div>
      ...
      <BreadCrumbs
        :bclinks="[
          ...
          {
            text: 'Service Section Two',
            link: '/service/service-section-two',
            disabled: true
          }
        ]"
      />
        ...
        <v-col cols="12" md="12">
          ...
          <v-flex class="zd-custom-tbl">
            ...
            >
              ...
              <!-- need details -->
              <template v-slot:item.need_details="{ item }">
                <div class="ad-description" v-html="item.need_details"></div>
              </template>
      ...
      >
        ...
        <!-- End of Close Button -->
        <div class="de-drawer-header">Add New Service Section Two</div>
        <v-divider></v-divider>
      ...
      >
        ...
        <!-- End of Close Button -->
        <div class="de-drawer-header">Edit Service Section Two</div>
        <v-divider></v-divider>
        <div class="de-box de-drawer-content-box">
...
import {
  addNewServiceSectionTwoUrl,
  allServiceNameUrl,
  changeFaqStatusUrl,
  deleteServiceSectionTwoUrl,
  getAllServiceSectionTwoUrl,
  getSingleServiceSectionTwoUrl,
  updateServiceSectionTwoUrl
  ...
  computed: {
    ...
    isValidToAddFaq() {
      if (
        ...
        this.newFaq.details &&
        this.newFaq.need_title &&
        this.newFaq.need_details
      ) {
        return true
      } else {
        return false
  ...
  methods: {
    ...
    async getSingleFaq(pageId) {
      ...
      try {
        ...
        await _this.$axios
          .$get(getSingleServiceSectionTwoUrl, {
            params: {
              pageId: pageId
            }
          })
    ...
    async getAllFaq() {
      ...
      try {
        _this.faqLoading = true
        await _this.$axios
          .$get(getAllServiceSectionTwoUrl)
          .then((response) => {
            _this.faqLoading = false
            _this.faqData = response
          })
    ...
    async addNewFaq() {
      ...
      try {
        ...
        await _this.$axios
          .$post(addNewServiceSectionTwoUrl, {
    ...
    async updateFaq() {
      ...
      try {
        ...
        await _this.$axios
          .$post(updateServiceSectionTwoUrl, {
        ...
        _this.$swal
          .fire({
            ...
            preConfirm: () => {
              ...
              return _this.$axios
                .$delete(`${deleteServiceSectionTwoUrl}/${id}`)
              ...
              if (response && response.STATUS === 400) {
                ...
                _this.faqData.splice(
                  _this.faqData
                    ...
                    .indexOf(response.serviceSectionTwoInfo.id),
                  1
                )
                _this.$toast.success(
                  response.MESSAGE,
