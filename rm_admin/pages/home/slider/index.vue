  ...
  <client-only>
    <div>
      ...
      <v-row>
        <v-col cols="12" md="12">
          ...
          >
            <!--start table header-->
            <v-layout>
              <v-flex xs8 sm8 md8 class="zd-tbl-title">Banner</v-flex>
            </v-layout>
      ...
      >
        ...
        <!-- End of Close Button -->
        <div class="de-drawer-header">Add New Banner</div>
        <v-divider></v-divider>
                ...
                <v-form ref="addAdminForm">
                  <v-layout row wrap>
                    ...
                    <v-flex xs12 sm12 md12>
                      ...
                      >
                        <v-file-input
                          v-model="newServicePage.video"
                          label="Banner Bg Video"
      ...
      >
        ...
        <!-- End of Close Button -->
        <div class="de-drawer-header">Edit Banner</div>
        <v-divider></v-divider>
        <div class="de-box de-drawer-content-box">
          <ValidationObserver
                  ...
                  <v-layout row wrap>
                    ...
                    <v-flex xs12 sm12 md12>
                      <ValidationProvider
                        ...
                        rules="required"
                        vid="fname"
                        name="Banner Bg Video  *"
                      >
                        <v-file-input
                          v-model="editServicePage.video"
                          label="Banner Bg Video"
                          prepend-icon="mdi-paperclip"
                          outlined
                        >
  ...
  computed: {
    ...
    isValidToServicePage() {
      if (
        ...
        this.newServicePage.link &&
        this.newServicePage.video
      ) {
        return true
      } else {
        return false
  ...
  methods: {
    ...
    async addNewServicePage() {
      try {
        ...
        formData.append('video', _this.newServicePage.video)
        ...
        formData.append('newServicePage.link', _this.newServicePage.link)

        await _this.$axios
          .$post(`${addNewBannerUrl}`, formData)
          .then((response) => {
    ...
    async updateServicePage() {
      try {
        ...
        var formData = new FormData()
        formData.append('video', _this.editServicePage.video)
        ...
        formData.append('editServicePage.link', _this.editServicePage.link)
