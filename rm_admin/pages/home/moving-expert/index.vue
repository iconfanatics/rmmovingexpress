  ...
  <client-only>
    <div>
      ...
      >
        ...
        <!-- End of Close Button -->
        <div class="de-drawer-header">Add New Moving Expert</div>
        <v-divider></v-divider>
...
import {
  addNewMovingExpertUrl,
  allMovingExpertUrl,
  changeMovingExpertStatusUrl,
  deleteMovingExpertUrl,
  UpdateMovingExpertUrl
  ...
  methods: {
    ...
    async addNewServicePage() {
      try {
        ...
        await _this.$axios
          .$post(`${addNewMovingExpertUrl}`, formData)
          .then((response) => {
    ...
    async updateServicePage() {
      try {
        ...
        await _this.$axios
          .$post(`${UpdateMovingExpertUrl}`, formData)
          .then((response) => {
        ...
        _this.$swal
          .fire({
            ...
            preConfirm: () => {
              ...
              return _this.$axios
                .$delete(`${deleteMovingExpertUrl}/${id}`)
        ...
        _this.$swal
          .fire({
            ...
            preConfirm: (isConfirm) => {
              return _this.$axios
                .$post(changeMovingExpertStatusUrl, {
                  movingExpertId: servicePageId
                })
                .then((response) => {
                  return response
                })
