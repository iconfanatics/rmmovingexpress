<template>
  <client-only>
    <div>
      ...
      <!-- Adding New Home Service Drawer -->
      <v-navigation-drawer
      ...
      >
        ...
        <!-- End of Close Button -->
        <div class="de-drawer-header">Add New Home Service</div>
        <v-divider></v-divider>
      ...
      >
        ...
        <!-- End of Close Button -->
        <div class="de-drawer-header">Edit Home Service</div>
        <v-divider></v-divider>
        <div class="de-box de-drawer-content-box">
...
<script>
import {
  addNewHomeServiceUrl,
  allHomeServiceUrl,
  allServiceNameUrl,
  changeHomeServiceStatusUrl,
  deleteHomeServiceUrl,
  UpdateHomeServiceUrl
  ...
  methods: {
    ...
    async addNewFaq() {
      ...
      try {
        ...
        await _this.$axios
          .$post(addNewHomeServiceUrl, {
            faqInfo: _this.newFaq
          })
          .then((response) => {
        ...
        _this.$swal
          .fire({
            ...
            preConfirm: (isConfirm) => {
              return _this.$axios
                .$post(changeHomeServiceStatusUrl, {
                  faqId: faqId
                })
                .then((response) => {
                  return response
    ...
    async updateFaq() {
      ...
      try {
        ...
        await _this.$axios
          .$post(UpdateHomeServiceUrl, {
            faqInfo: _this.editFaq
          })
          .then((response) => {
        ...
        _this.$swal
          .fire({
            ...
            preConfirm: () => {
              ...
              return _this.$axios
                .$delete(`${deleteHomeServiceUrl}/${id}`)
