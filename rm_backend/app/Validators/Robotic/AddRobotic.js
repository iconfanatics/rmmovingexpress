...
class AddRobotic {
  ...
  get rules() {
    const rules = {
      'newRobotics.name': `required`,
      'newRobotics.title': `required`,
      'newRobotics.classification_id': `required`,
      'newRobotics.country_id': `required`,
      'newRobotics.robotics_categorie_id': `required`,
      'newRobotics.robotic_generations_id': `required`,
      'newRobotics.quantity': `required`,
      'newRobotics.location': `required`,
      'newRobotics.description': `required`,
      'newRobotics.market_value': `required`,
      'newRobotics.expired_time': `required`,
      'newRobotics.added_by': `required`,
      'photo': `required`,
    }
    return rules
  }
  ...
  get messages() {
    return {
      'roboticInfo.title.required': 'Title is required',
