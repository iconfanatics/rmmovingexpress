...
class UpdateRobotiGeneration {
  ...
  get rules() {
    const rules = {
      'editGeneration.generation_name': `required`,
      'editGeneration.added_by': `required`
    }
    return rules
  }
  /**
  ...
  get messages() {
    return {
      'newGeneration.generation_name.required': 'Name is required',
...
module.exports = UpdateRobotiGeneration
