...
class AddRobotiCategory {
  ...
  get rules() {
    const rules = {
      'newCategory.category_name': `required`,
      'newCategory.short_name': `required`,
      'newCategory.added_by': `required`
    }
    return rules
  }
  /**
  ...
  get messages() {
    return {
      'newCategory.category_name.required': 'Title is required',
...
module.exports = AddRobotiCategory
