...
class AddCountry {
  ...
  get rules() {
    const rules = {
      'newCountry.name': `required`,
      'newCountry.iso_code': `required`,
      'newCountry.continent_id': `required`,
      'newCountry.isd_code': `required`,
      'newCountry.property_value_ground_one': `required`,
      'newCountry.property_value_ground_two': `required`,
      'newCountry.billboard_value_ground_one': `required`,
      'newCountry.billboard_value_ground_two': `required`,
    }
    return rules
  }
  /**
