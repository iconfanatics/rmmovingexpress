...
class UpdateResourceCategory {
  ...
  get rules() {
    const rules = {
      'editCategory.category_name': `required`,
      'editCategory.price': `required`,
      'editCategory.added_by': `required`
    }
    return rules
  }
  /**
  ...
  get messages() {
    return {
      'editCategory.category_name.required': 'Title is required',
    }
  }
  /**
...
module.exports = UpdateResourceCategory
